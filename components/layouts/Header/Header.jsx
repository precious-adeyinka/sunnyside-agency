...
const Header = () => {
  ...
  return (
    <header className={`h-auto w-full mb-2 ${isOnMobileViewport ? styled.headerBgMobile : styled.headerBgDesktop}`} id="header">
      <div className="h-[35rem] md:h-[45rem] w-full bg-transparent">
        ...
        <div className="h-80 md:h-[25rem] w-full bg-transparent pt-16 md:pt-16 flex flex-col justify-center md:jusify-between items-center space-y-10 md:space-y-20">
          <h1 className="text-4xl md:text-5xl text-white font-bold text-center leading-tight font-fraunces tracking-widest">WE ARE CREATIVES</h1>
